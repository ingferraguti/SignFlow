...
class ReportWorkflowRulesTest {
    ...
    void definesTheCompleteLifecycleAndRejectsSkippedTransitions() {
        Map<ReportState, Set<ReportState>> expected = Map.ofEntries(
                ...
                Map.entry(ReportState.REVIEW_PENDING, Set.of(ReportState.INCOMPLETE, ReportState.APPROVED)),
                Map.entry(ReportState.APPROVED, Set.of(ReportState.SIGN_BATCH_CREATED, ReportState.SIGNING)),
